...
import logging
from app.shared.mongo import get_data_edge, get_sector
...
with tab1:
    create_table(df_ranking,sort_by="value_score", ascending=True, limit=10, caption="Value Score", symbol=None,show_company=False)
